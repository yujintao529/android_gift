...
***************************************************************************************/
public class Level9Scene extends IScene implements BitmapOnDrawListener {
	...
	public Level9Scene(Context context, int number, int width, int height) {
	...
	public Level9Scene(Context context, int width, int height) {
